package com.example.droidman.customviewmock.customviews;

import com.example.droidman.customviewmock.R;
...
/**
 * Created by Droidman on 8/26/2017.
 */
...
public class ProgressCircle extends View {
    ...
    public ProgressCircle(Context context,
        ...
        try{
            fillColor = a.getColor(R.styleable.ProgressCircle_fillColor, Color.WHITE);
            strokeColor = a.getColor(R.styleable.ProgressCircle_strokeColor,Color.BLACK);
            strokeWidth = a.getColor(R.styleable.ProgressCircle_strokeWidth,1);
            value = a.getInteger(R.styleable.ProgressCircle_value,0);
            adjustValue(value);
        }
        finally {
            a.recycle();
